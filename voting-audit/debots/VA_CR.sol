...
interface VotingAuditDebotACTMmenu {
...
*/
    ...
    function mainMenu() public {
        Menu.select("Welcome to Radiance Voting Audit debot interface.", "", [
            MenuItem("DEV set avtm debot address", "", tvm.functionId(setACTMdebAddress)),
...
//                        MenuItem("", "Collator", tvm.functionId(removeMemberEnterAddress)),
//                        MenuItem("", "Validator", tvm.functionId(getBalanceOf)),
    ...
    function enterATMdebot() public {
        VotingAuditDebotACTMmenu(m_actmAddress).preStart(m_participant);
    }
