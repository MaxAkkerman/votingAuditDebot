...
//    address choosenDADaddress = address.makeAddrStd(0, 0xc9d81bb29dcbdf531db223524ed8e5bdc8af2073100e29d809670b542c2b5022);
    ...
    address choosenDADaddress = address.makeAddrStd(0, 0xea7967d5f213b327b0b243960b01bb8933a7c74dbf8887376c157d2b5e51ea78);
...
uint256 curDistrIndexD;
    ...
    function setTouchedDistrict(uint32 index) public {
        ...
        Terminal.print(toundDistrictsID, format("\n ----You touched District index: {}\n", curDistrIndexD));
...
//
//                Terminal.print(0, format("curmb --- curmb: {}", curmb));

//            for(uint8 k = 0; k < MBarr.length; k++){
//
//                    uint256 curmbar = MBarr[k];
//
//                    Terminal.print(0, format("touchMB --- curmb: {},curmbar: {}", curmb,curmbar));
//                    if(curmb == curmbar){
