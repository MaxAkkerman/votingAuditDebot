...
contract VotingAuditDebotVL is Debot {
    ...
    address m_DeAuditRoot = address.makeAddrStd(0, 0x67d07ae1b594acad31b46fd6395fa2de8c64753b2545c26919d82383f9285aea);
...
*/
    ...
    function prestart(address m_participantC, address DeAuditRoot) public {
    ...
    function showallV(uint32 index) public {
            ...
            for(uint8 i = 0; i < voteKeysD.length; i++){
                ...
                VoteD cp = voteD[curK];
                    ...
                    string curVdata = format("======\ncurK:{}\nvotingID: {}\ninitiator:{}\nstartTime: {}\nduration: {}\nyesCount: {}\nnoCount: {}\n actionType:{}",curK,votingID, cp.initiator, cp.startTime, cp.duration,cp.yesCount,cp.noCount,cp.actionType);
...
uint256 votingID;
    ...
    function goToACTMdebot(uint32 index)public{
        IVAdebotACTMmenu(m_VAdebotACTMmenuAddress).preStart(m_participant);
    }
